...
RYAN, GOLD, PETERSON = classes.load_test_objects()


class TestDatabase(unittest.TestCase):

    def setUp(self):
        classes.DB.create(DATABASE)
    ...
    def test_options_retrieval(self):
        with classes.DB(DATABASE) as db:
            options = db.options()
...
class Feed(unittest.TestCase):
    ...
    def test_add_bad_podcast(self):
            with classes.Feed(DATABASE) as feed:
                feed.add('google.com')
    ...
    def test_add_podcast(self, mock_method):
        ...
        with classes.Feed(DATABASE) as podcast:
...
class TestPodcast(unittest.TestCase):
    ...
    def setUp(self, mock_method):
        ...
        classes.create_test_objects()
        classes.DB.create(DATABASE)
        with classes.Feed(DATABASE) as db:
            db.add(RYAN_URL)
    ...
    def test_episode_image(self, fp_mock):
        ...
        with classes.Podcast(DATE, DIR_PATH, '', DATABASE) as pod:
